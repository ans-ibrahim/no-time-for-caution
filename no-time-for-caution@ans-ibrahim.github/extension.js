...
class Indicator extends PanelMenu.Button {
    _init(settings) {
        ...
        this.label = new St.Label({ text: _('Calculating...'), y_align: Clutter.ActorAlign.CENTER });
...
export default class NoTimeForCautionExtension extends Extension {
    enable() {
        ...
        Main.panel.addToStatusArea('no-time-for-caution@ans-ibrahim.github',this._indicator,this.settings.get_int('indicator-index'),this.settings.get_string('indicator-position'));
